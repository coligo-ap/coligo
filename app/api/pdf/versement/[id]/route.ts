...
const RED = rgb(0.86, 0.21, 0.27);
const SOFT = rgb(0.965, 0.955, 0.99);
...
const DAY_FMT = new Intl.DateTimeFormat("fr-DZ", {
  day: "2-digit",
  month: "2-digit",
  year: "2-digit",
...
function makeText(page: PDFPage, fonts: Fonts) {
  return (
    s: string,
    x: number,
    y: number,
...
function fit(s: string, f: PDFFont, size: number, max: number): string {
