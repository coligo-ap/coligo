  ...
  return (
    <main className="bg-surface-2 min-h-screen">
      <div className="mx-auto max-w-3xl animate-pulse px-4 py-10">
        <div className="bg-surface h-4 w-16 rounded-[8px]" />
        <div className="cg-brand-gradient mt-6 h-64 rounded-[16px] opacity-60" />
        <div className="bg-surface mt-8 h-5 w-48 rounded-[8px]" />
