...
export default function MerchantLoading() {
  return (
    <div className="mx-auto max-w-[1100px] p-4 lg:p-6 lg:px-8">
      <div className="bg-surface-3 mb-6 h-8 w-52 animate-pulse rounded-[12px]" />
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        <div className="bg-surface-3 h-64 animate-pulse rounded-[16px] lg:col-span-2" />
        <div className="bg-surface-3 h-64 animate-pulse rounded-[16px]" />
      </div>
    </div>
  );
}
