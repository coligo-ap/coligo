  ...
  return (
    <CustomerShell>
      <div className="mx-auto max-w-xl px-4 py-10 text-center lg:py-16">
        ...
        <h1 className="text-foreground mt-4 text-2xl font-bold">Ton panier</h1>
        <p className="text-muted mt-2 text-sm">
          La commande chez les commerçants arrive très bientôt. Pour
          l&apos;instant, tu peux découvrir leurs vitrines.
        </p>
        <Link
          href="/"
