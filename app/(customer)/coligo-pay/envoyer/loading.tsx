...
export default function ColigoPayEnvoyerLoading() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-4 lg:px-6 lg:py-8">
      ...
      <div className="bg-surface-3 mt-4 h-14 animate-pulse rounded-[16px]" />
      <div className="bg-surface-3 mt-3 h-24 animate-pulse rounded-[16px]" />
      <div className="bg-surface-3 mt-3 h-14 animate-pulse rounded-[16px]" />
