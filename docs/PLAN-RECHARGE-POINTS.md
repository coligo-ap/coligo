...
| **2**    | Enforcement (étendre `driver_can_accept`, accept course, trigger `orders` commerçant)                                                                                                                                                | 1         | 0186                |
| **3**    | Recharge manuelle (preuve, queue admin, `approve_topup_request`) + recharge Chargily                                                                                                                                                 | 1         | 0187                |
| **4**    | Compte `pro` partenaire + `coligo_recharge_sell` + PIN opérateur + bonus admin                                                                                                                                                       | 1         | 0188                |
| **5**    | Annuaire « Où recharger » (`recharge_points_nearby` + sections livreur/chauffeur/commerçant)                                                                                                                                         | 4         | 0189                |
| **6**    | Admin complet (points, plafonds, historique, activation)                                                                                                                                                                             | 3,4       | —                   |
| **7**    | Nouveaux tarifs abonnements chauffeur (config tarifaire seule)                                                                                                                                                                       | —         | —                   |
