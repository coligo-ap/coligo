...
const TITLE_AR = "كوليڨو — توصيل ومشتريات";
const TITLE_EN = "Coligo: Delivery in Algeria";

const SHORT_AR =
  "توصيل الطعام والمشتريات من المتاجر القريبة — ادفع نقدًا أو إلكترونيًا.";
const FULL_AR = `كوليڨو هو تطبيق التوصيل الجزائري: اطلب وجباتك ومشترياتك من المتاجر والمطاعم القريبة منك، وتابع طلبك مباشرة حتى باب منزلك.
...
• كوليڨو درايف: مشاوير بسيارة أو دراجة نارية بأسعار واضحة
• كوليڨو باي: محفظة رقمية للدفع بالمسح السريع QR واسترجاع كاش باك على طلباتك
• عروض وتخفيضات يومية من التجار المحليين
• تتبّع مباشر للطلب والموصّل على الخريطة
• واجهة كاملة بالعربية، وبالفرنسية والإنجليزية

كوليڨو يدعم التجار المحليين في كل ولايات الجزائر: كل طلب منك يساعد متجر حيّك.
