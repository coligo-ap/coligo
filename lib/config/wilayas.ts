...
export const WILAYAS: Wilaya[] = [
  ...
  { code: "54", name: "In Guezzam", name_ar: "عين قزام", is_new: true },
  { code: "55", name: "Touggourt", name_ar: "تقرت", is_new: true },
  { code: "56", name: "Djanet", name_ar: "جانت", is_new: true },
  { code: "57", name: "El M'Ghair", name_ar: "المغير", is_new: true },
  { code: "58", name: "El Meniaa", name_ar: "المنيعة", is_new: true },
];
