-- =============================================================================
-- 0392 — Bannières : ILLUSTRATION choisie librement (indépendante du modèle)
-- =============================================================================
-- Le modèle (mig 0391) fixait l'illustration ET le dégradé ensemble. Le
-- super-admin peut désormais FORCER l'illustration 3D d'une bannière,
-- indépendamment du modèle : n'importe laquelle des illustrations
-- auto-hébergées (scooter, percent, megaphone, confetti, emoji-stars,
-- cashback) ou « none » (aucune). NULL / 'auto' = celle du modèle.
-- =============================================================================

ALTER TABLE public.promo_banners
  ADD COLUMN IF NOT EXISTS illustration TEXT;

-- Le type de retour CHANGE (nouvelle colonne) → DROP puis recréation.
...
AS $$
  SELECT
    ...
    b.overlay_opacity,
    b.link, b.accent, b.template, b.palette, b.illustration, b.show_products,
    b.position,
