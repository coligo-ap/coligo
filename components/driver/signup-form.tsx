      ...
      >
        <div className="space-y-1.5">
          ...
          <select
            ...
            className="focus:border-primary-600 h-12 w-full rounded-md border border-[var(--line)] bg-[var(--surface)] px-3 text-sm font-medium text-[var(--ink)] outline-none disabled:opacity-50"
          >
