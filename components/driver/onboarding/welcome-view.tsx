...
export function DriverWelcomeView({
  ...
  const choose = (mode: "merchant" | "express") =>
    start(async () => {
      ...
      if (!r.ok || !r.route) {
        setError(r.error ?? "Impossible de terminer l'inscription.");
        return;
      }
    ...
    return (
      ...
      >
        ...
        <p className="mx-auto mt-2.5 max-w-[320px] text-[13.5px] leading-relaxed text-[var(--muted)]">
          L&apos;équipe Coligo a vérifié votre compte. Vous pouvez désormais
          commencer à générer des revenus immédiatement.
        </p>
  ...
  return (
    ...
    >
      ...
      <ModeCard
        ...
        title="Accéder au mode Express maintenant"
        text="Recevez directement les livraisons des commerçants autour de vous. Aucune inscription préalable : mettez-vous en ligne et les courses arrivent."
        cta="Démarrer en Express"
        highlight
        pending={pending}
      ...
      <ModeCard
        ...
        text="Saisissez le code d'un commerçant partenaire pour intégrer son équipe et accéder à ses tournées planifiées."
        cta="Saisir un code commerçant"
        pending={pending}
      ...
      >
        Découvrir l&apos;application en 4 écrans
      </button>
