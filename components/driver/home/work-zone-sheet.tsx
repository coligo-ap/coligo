...
export function WorkZoneSheet({
  ...
  return (
    ...
    <Portal>
      ...
      >
        <div
          className="rounded-t-sheet-xl sm:rounded-sheet-xl shadow-overlay w-full max-w-md overflow-hidden bg-[var(--surface)] pb-[calc(0px+env(safe-area-inset-bottom))] text-[var(--ink)] sm:pb-0"
