...
export function DriverBalancePill({ driverId }: { driverId: string }) {
  ...
  return (
    <button
      ...
      className={`text-body-sm flex items-center gap-1.5 rounded-full border border-[var(--line)] bg-[var(--surface)] px-3 py-2 font-bold ${negative ? "text-[var(--red)]" : "text-[var(--violet)]"}`}
    >
