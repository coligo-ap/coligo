...
export function DriverBalancePill() {
  ...
  return (
    <button
      ...
      className={`border-border bg-surface absolute top-3 right-3 z-20 flex items-center gap-1.5 rounded-full border px-3 py-2 text-[13px] font-bold shadow-lg ${negative ? "text-danger-700" : "text-primary-600"}`}
    >
