...
// =============================================================================
// Vue « Argent livraison » (ledger livreurs + compteurs commandes + audit) —
// contenu seul, sans conteneur externe. Partagée entre /admin/livraison (route
// transverse conservée) et l'onglet Finances du hub Livraison
// (/admin/drivers/finances). Aucune logique métier modifiée : lecture seule.
