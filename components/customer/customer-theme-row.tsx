 ...
 *
 * C'est la porte d'entrée du mode sombre sur TÉLÉPHONE depuis que le header
 * marketplace ne porte plus que la zone (au centre) + cloche + panier. Le
 * header DESKTOP garde sa lune, et les écrans de connexion la portent aussi
