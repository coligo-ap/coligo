...
export function DWait() {
  return (
    <div className="drive-jakarta min-h-screen bg-white px-5 pt-10 pb-8">
      <div className="text-center">
        ...
        <p className="mx-auto mt-1 max-w-[290px] text-[13px] text-[#6B7280]">
  ...
  return (
    <div className="flex gap-3">
      <div className="flex flex-col items-center">
        ...
        {!last && <span className="min-h-[18px] w-[2px] flex-1 bg-[#EEF0F4]" />}
      </div>
  ...
  return (
    <div className="drive-jakarta min-h-screen bg-white px-5 pt-10 pb-8">
      <div className="text-center">
        ...
        <p className="mx-auto mt-1 mb-3 max-w-[300px] text-[13px] text-[#6B7280]">
          Votre compte chauffeur a été suspendu par Coligo.{" "}
          {reason ? (
            <>
              Motif : <b className="text-[#0B0C12]">{reason}</b>
            </>
          ) : (
            "Motifs possibles :"
          )}
      ...
      {motifs.map((m) => (
        ...
        >
          ...
          <span>
            ...
            <small className="text-[11px] text-[#6B7280]">{m.sub}</small>
          </span>
        </div>
      ))}
      <PrimaryBtn
...
export function DBlocked() {
  return (
    <div className="drive-jakarta grid min-h-screen place-items-center bg-white px-5">
      <div className="text-center">
        <span
          className="mx-auto mb-3 grid size-16 place-items-center rounded-full"
          style={{ background: "rgba(229,72,77,.12)" }}
