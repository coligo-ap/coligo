...
export function OrderSupportButton({
  ...
  return (
    <button
      ...
      className={
        className ??
        "border-border bg-surface text-foreground hover:bg-surface-2 text-body-sm flex w-full items-center justify-center gap-2 rounded-lg border px-4 py-3 font-bold transition-colors"
      }
    >
